...
public class BD {
    ...
    private static final String SQL_CREATE_PACIENTES="DROP TABLE IF EXISTS PACIENTES; CREATE TABLE PACIENTES (" +
    ...
    public static Connection getConnection() throws Exception{
        ...
        return DriverManager.getConnection("jdbc:h2:mem:~/C14Clinica","sa", "sa");
    }
}
